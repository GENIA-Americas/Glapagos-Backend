    ...
    def _check_redis(self):
        try:
            ...
            if channel_layer is None:
                return "error"
            # Channels Redis layer doesn't expose a ping, but if we can
            # get the layer without error, Redis is reachable at config time.
            # We verify further by checking the layer can hold a connection.
            return "ok"
        except Exception:
            return "error"
