...
def send_private_data_mail(data: dict, emails: list[str], locale: str = "en"):
...
def send_change_password_mail(data: dict, emails: list, locale: str = "en"):
...
def send_activate_account_mail(data: dict, emails: list, locale: str = "en"):
