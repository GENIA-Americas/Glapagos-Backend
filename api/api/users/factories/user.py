...
class UserFactory(factory.django.DjangoModelFactory):
    ...
    email = factory.LazyAttribute(lambda p: f"{p.first_name}.{p.last_name}@mail.com")
    ...
    setup_status = factory.LazyAttribute(
        lambda _: random.choice(list(SetUpStatus._value2member_map_.values()))
    )
