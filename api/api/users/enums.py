...
class Industry(models.TextChoices):
    ...
    TRANSPORTATION_AND_LOGISTICS = "Transportation and Logistics", _(
        "Transportation and Logistics"
    )
    SHIPBUILDING = "Shipbuilding", _("Shipbuilding")
    AGRICULTURE_AND_LIVESTOCK = "Agriculture and Livestock", _(
        "Agriculture and Livestock"
    )
    HEALTHCARE_AND_BIOTECHNOLOGY = "Healthcare and Biotechnology", _(
...
class Country(models.TextChoices):
    ...
    SAINT_VINCENT_AND_THE_GRENADINES = "Saint Vincent and the Grenadines", _(
